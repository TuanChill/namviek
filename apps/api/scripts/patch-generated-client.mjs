...
const clientPath = resolve(__dirname, '../src/generated/client/client.ts')
...
if (src.includes(MARKER)) {
  ...
  console.log('✅ Patched src/generated/client/client.ts for Cloudflare Workers compatibility.')
} else {
